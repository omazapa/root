...
the list of possible common configuration parameters. As in case of the minimier type, the class supports setting static default options
that will be used for every minimization.

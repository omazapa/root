...
IpoptMinimizer::IpoptMinimizer() : BasicMinimizer()
{
   ...
   fIpotApp->Options()->SetStringValue("hessian_approximation", "limited-memory");
   // fIpotApp->Options()->SetStringValue("mu_strategy", "adaptive");
...
bool IpoptMinimizer::IpoptMinimizer::InternalTNLP::eval_grad_f(Index n, const Number *x, bool /*new_x*/, Number *grad_f)
{
   ...
   if (!gfun)
   {
      fMinimizer->fIpotApp->Options()->SetStringValue("gradient_approximation","finite-difference-values");
      return false;
   }
...
bool IpoptMinimizer::Minimize()
{
   ...
   //fIpotApp->Options()->SetNumericValue("symmetric", true);
   //fIpotApp->Options()->SetStringValue("pivot", "dynamic");

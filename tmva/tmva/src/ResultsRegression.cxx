...
{
   Log() << kINFO <<Form("Dataset[%s] : ",GetDataSetInfo()->GetName())<< "Create variable histograms" << Endl;
   const DataSetInfo* dsi = GetDataSetInfo();
   ...
   Log() << kINFO <<Form("Dataset[%s] : ",GetDataSetInfo()->GetName())<< "Create regression target histograms" << Endl;
   ...
   Log() << kINFO <<Form("Dataset[%s] : ",GetDataSetInfo()->GetName())<< "Create regression average deviation" << Endl;
   for (UInt_t itgt = 0; itgt < dsi->GetNTargets(); itgt++) {
   ...
   Log() << kINFO <<Form("Dataset[%s] : ",GetDataSetInfo()->GetName())<< "Results created" << Endl;
}

...
void ClassificationCategory()
{
  ...
  if (batchMode) factoryOptions += ":!Color:!DrawProgressBar";
   ...
   loader1->AddSpectator( "eta" );
   loader2->AddSpectator( "eta" );
   ...
   loader1->AddSignalTree    ( signal,     signalWeight     );
   loader1->AddBackgroundTree( background, backgroundWeight );

   loader2->AddSignalTree    ( signal,     signalWeight     );
   loader2->AddBackgroundTree( background, backgroundWeight );
...
//                         "!H:!V:TransformOutput:PDFInterpol=Spline2:NSmoothSig[0]=20:NSmoothBkg[0]=20:NSmoothBkg[1]=10:NSmooth=1:NAvEvtPerBin=50" ); 
   ...
   TMVA::MethodBase* fiCat = factory->BookMethod(loader1, TMVA::Types::kCategory, "FisherCat","" );

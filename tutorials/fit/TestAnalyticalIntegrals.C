...
void TestAnalyticalIntegrals()
{
   ...
   f_pol3->Draw();
   std::cout<<"int pol3 "<<f_pol3->Integral(-5.,5.)<<std::endl;
   ...
   f_cb->Draw();
   cout<<"num int cb "<<f_cb->Integral(-5.,5.)<<endl;
   cout<<"ana int cb "<<ROOT::Math::crystalball_cdf(5,1,2,3.,0.3)-ROOT::Math::crystalball_cdf(-5,1,2,3.,0.3)<<endl;
